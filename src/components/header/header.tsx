...
const Header = () => {
  ...
  return (
    <div className={` w-[102rem] h-96 my-20 duration-300  ${isOpen ? "ml-[22rem] w-[92rem]" : "ml-40"} bg-gradient-to-r from-purple to-pinkBorder rounded-2xl pl-20`}>
        <div className="flex justify-between items-center h-full relative">
          <div className="font-font3 text-8xl text-white w-3/4">
            <h1>Find your perfect</h1>
            <h1>3d model</h1>            
          </div>
          <div className="absolute transform -translate-x-[10rem] translate-y-[2rem]">
            <img src="src\assets\img\cloud2.gif" alt="rocket animation"/>
          </div>
          <div className="absolute transform translate-x-[80rem] -translate-y-[10rem]">
